...
if (isset($_POST['result_message'])) {
    ...
    if (strpos($alertContent, 'White Win!') !== false) {
        // "Black Win!"の場合、勝利数(wins)を増やす
        $wins++;
    } elseif (strpos($alertContent, 'Black Win!') !== false) {
...
<body>
    ...
    <div id="ui_board"></div>
    <script src="src/boardw.js"></script>
    <script src="src/playerw.js"></script>
    <script src="src/gamew.js"></script>
    <script src="src/uiw.js"></script>
    <script src="src/mainw.js"></script>
