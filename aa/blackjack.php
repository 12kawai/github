...
<p>ルール１:　ヒットを押すとカードを追加します。スタンドを押すと現時点の得点で勝負します。<br>ルール２:　21に一番近い数か21を出したほうが勝ちです。21を超えたら負けになります。<br>ルール３:　合計得点が同じ時はカードの枚数が多いほうが勝ちになります。<br>ルール４:　１のカードは特別で１または１１として、扱うことができます。<br>ルール５:　10を含むカードは全て「10」として数えられます。（10、J、Q、K）</p>
        ...
        <body>
            ...
            <script language="JavaScript">
                ...
                function BrackJack () {
                    ...
                    work = "<p id='winner' style='color:black'>"
                    work += "勝敗：";
                    work += "</p>";
                    ...
                    this.JudgeWinner = function() {
                        ...
                        result = "<p id='result' style='color:black'>";
                        result += bj + "勝(BJ) ";
                        result += win + "勝 ";
                        result += lose + "負 ";
                        result += nogame + "引分";
