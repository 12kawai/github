...
<?php
    ...
    <a href="http://localhost/o/index.php" onmouseover="showImage('gazo10.png')" onmouseout="hideImage()">スイカゲームを始める</a>
    <a href="http://localhost/suik/taru.php" onmouseover="showImage('gazo16.png')" onmouseout="hideImage()">樽避けゲームを始める</a>
    ...
    <script>
        ...
        function openRandomLink() {
            ...
            var links = [
                ...
                "oserom.php",
                "http://localhost/o/index.php",
                "http://localhost/suik/taru.php",
